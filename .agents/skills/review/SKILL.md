...
3. Run it. Check out the branch, run the check command written down in `AGENTS.md`, and exercise the thing the change claims to fix. A reviewer who did not run the change is reading, not reviewing.
